...
export const builtInRecipeLenses = [
  {
    ...
    description: "Trim calories while protecting flavor and texture.",
    sortOrder: 10,
  },
  {
    ...
    shortLabel: "Glucose",
    description: "Favor steadier blood glucose with satisfying structure.",
    sortOrder: 20,
  },
  {
    key: "quick",
    label: "Quick",
    shortLabel: "Quick",
    description: "Reduce active and total time while preserving the core dish.",
    sortOrder: 30,
  },
  {
    key: "max-flavor",
    ...
    description: "Spend reasonable extra effort on flavor and texture.",
    sortOrder: 40,
  },
] as const;
